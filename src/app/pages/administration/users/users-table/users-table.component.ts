...
export class UsersTableComponent implements OnInit {
  ...
  displayedColumnsAr: string[] = ['fullName', 'libelleAdmProfile', 'ipAddress', 'uri', 'resultWs', 'dateLog'];
  displayedColumnsEn: string[] = ['fullName', 'libelleAdmProfile', 'ipAddress', 'uri', 'resultWs', 'dateLog'];
