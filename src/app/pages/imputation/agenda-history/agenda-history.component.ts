...
@Component({
  selector: 'app-agenda-history',
  templateUrl: './agenda-history.component.html',
  styleUrls: ['./agenda-history.component.scss']
})
export class AgendaHistoryComponent implements OnInit {
  ...
  constructor( private agendaService :AgednaService, private router: Router) { }
...
addtrace(){
  this.router.navigate(["/imputation/agenda"]);
}
